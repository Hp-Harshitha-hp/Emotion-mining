...
<table width="778" border="1">
				  ...
				  <tr>
					<td width="244" bgcolor="#FF0000" ><div align="left" class="style4 style5 style35 style1 style2">
						<div align="center" class="style1">Commented User </div>
					</div></td>
					<td width="230" bgcolor="#FF0000" ><div align="left" class="style4 style36 style1 style2">
						<div align="center">Comment</div>
					</div></td>
					<td width="266" bgcolor="#FF0000"><div align="left" class="style37 style4 style1">
						<div align="center">Date</div>
					</div></td>
				  </tr>
<%
		   			  
	String s1="",s2="",s3="",s4="",s5="",s6="",s7="", pos="Angry" ;
...
-->
	...
	<!--<table width="778" border="1">
			   ...
			   {
					i=rs.getInt(1);
					s2=rs.getString(2).toLowerCase();//tname
			       ...
			       String sql1="select * from filter where categorie='"+pos+"' ";
					...
					while ( rs1.next() )
			   			{
			   			 String	t1=rs1.getString(1);//emotion name
			            String t2=rs1.getString(3).toLowerCase();//filter named..byme
