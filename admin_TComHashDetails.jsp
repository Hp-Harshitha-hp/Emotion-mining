...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="text">
        <h1><a href="#" class="style42">emotion correlation mining</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="article">
        <h4 class="style16 style43 style44">Re Tweet Details </h4>
        <div class="clr"></div>
        <div class="post_content">
          ...
          <table width="743" border="1" align="center">
            <tr>
              <td width="66" height="27" align="left" valign="bottom" bgcolor="#FFFFFF"><div align="center" class="style21 style28 style45">S.No</div></td>
              <td width="167" align="left" valign="bottom" bgcolor="#FFFFFF"><div align="center" class="style21 style28 style45">
                <div align="center">Comments</div>
              </div></td>
              <td width="257" align="left" valign="bottom" bgcolor="#FFFFFF"><div align="center" class="style21 style28 style45">
                  <div align="center">Commented By </div>
              </div></td>
			  
			   <td width="225" align="left" valign="bottom" bgcolor="#FFFFFF"><div align="center" class="style21 style28 style45">
