...
<%@ page import ="java.text.SimpleDateFormat" %>
            ...
            <%
					...
					try {
						...
						while (params.hasMoreElements()) 
						{
							...
							if(paramname.equalsIgnoreCase("CatType"))
							{
								cattype=multi.getParameter(paramname);
			...
			<p><a href="TSMain.jsp" class="style8">Back</a></p>
				<%
					...
					String strQuery2 = "insert into filter(categorie,CatType,filter) values('"+categorie+"','"+cattype+"','"+filter+"')";
