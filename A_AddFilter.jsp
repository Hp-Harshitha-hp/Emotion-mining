...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="text">
        <h1><a href="#" class="style40"></a>emotion correlation mining </h1>
      </div>
      <div class="menu_nav">
        <ul>
          <li><strong><a href="index.html" class="style22">Home</a></strong></li>
          <li><strong><a href="UserLogin.jsp" class="style22">User</a></strong></li>
          <li class="active style22"><a href="TSLogin.jsp"><strong>Tweet Admin </strong></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
...
<form name="s" method="post" enctype="multipart/form-data" action="A_AddFilter1.jsp" onSubmit="return valid()"  ons target="_top">            
    ...
    <table width="323" border="0" align="center"  cellpadding="0" cellspacing="0" >
				...
				<tr>
                   <!-- <td  width="117" valign="middle" height="50" style="color: #2c83b0;"><div align="left" class="style7 style15 style18 style21 style4" style="margin-left:20px;">Categorie Type </div></td>-->
                    <td  width="206" valign="middle" height="50" style="color:#000000;"><div align="left" style="margin-left:20px;"><label>
        				<!--<select id="s1" name="CatType">
         				<option>--Select--</option>
       					 <% for(int i1=0;i1<a11.size();i1++)
        	  				{
        	  				%>
           					<option><%= a11.get(i1)%></option>
...
%>
          ...
          <p align="center" class="style44"><table width="523" border="1" align="center">
              <tr>
                ...
                <!--<td width="143" align="left" valign="bottom" bgcolor="#FF0000"><div align="center" class="style35 style36 style32 style21 style45"><strong>Category Type </strong></div></td>-->
