...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="article">
        <h2 class="style16"><span class="style35">User</span><span class="style33"> <%=application.getAttribute("uname") %></span><span class="style35">'s all Tweets with Ranks </span></h2>
        <div class="clr"></div>
        <div class="post_content">
          <h2 align="center">
            <table width="523" border="1" align="center">
              <tr>
                <td width="48" align="left" valign="bottom" bgcolor="#FF0000"><div align="center" class="style21 style32 style36 style35">Id</div></td>
                <td width="165" height="31" align="left" valign="bottom" bgcolor="#FF0000"><div align="center" class="style21 style32 style36 style35">
                  <div align="center">Tweet Image </div>
                </div></td>
                <td width="143" align="left" valign="bottom" bgcolor="#FF0000"><div align="center" class="style21 style32 style36 style35">Tweet Name </div></td>
                <td width="139" align="left" valign="bottom" bgcolor="#FF0000"><div align="center" class="style21 style32 style36 style35">Rank</div></td>
              </tr>
              <%
